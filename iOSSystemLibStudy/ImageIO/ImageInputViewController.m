...
@interface ImageInputViewController () <UITableViewDataSource, UITableViewDelegate>
...
{
    static NSString *reuseIdentifier = @"ImageInput";
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([text isEqualToString:@"public.jpeg"] || [text isEqualToString:@"public.png"] || [text isEqualToString:@"com.compuserve.gif"]) {
        ImageInputTypeViewController *vc = [[ImageInputTypeViewController alloc] init];
        vc.type = text;
