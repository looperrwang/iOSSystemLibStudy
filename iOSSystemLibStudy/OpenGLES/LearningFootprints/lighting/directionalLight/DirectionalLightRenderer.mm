...
@interface DirectionalLightRenderer ()
...
@implementation DirectionalLightRenderer
...
- (void)initGLResource
{
    ...
    NSString *modelVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/directionalLight/shaders/cube.vert"];
    NSString *modelFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/directionalLight/shaders/cube.frag"];
    _modelShader = new Shader(modelVertexPath.UTF8String, modelFragPath.UTF8String);
    
    NSString *lampVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/directionalLight/shaders/lamp.vert"];
    NSString *lampFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/directionalLight/shaders/lamp.frag"];
...
- (void)render
{
    ...
    GLfloat lampDir[3] = {0.0f, 0.0f, -1.0f};
    glUniform3f(glGetUniformLocation(_modelShader->_programId, "light.direction"), lampDir[0], lampDir[1], lampDir[2]);
