...
@interface LightWithMapRenderer ()
...
@implementation LightWithMapRenderer
...
- (void)initGLResource
{
    ...
    NSString *modelVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMap/shaders/cube.vert"];
    NSString *modelFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMap/shaders/cube.frag"];
    _modelShader = new Shader(modelVertexPath.UTF8String, modelFragPath.UTF8String);
    
    NSString *lampVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMap/shaders/lamp.vert"];
    NSString *lampFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMap/shaders/lamp.frag"];
...
- (void)render
{
    ...
    //设置light.position
    GLfloat lampPos[3] = {0.8f, 0.8f, 0.5f};
