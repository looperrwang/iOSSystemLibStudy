...
@interface LightWithMaterialRenderer ()
...
@implementation LightWithMaterialRenderer
...
- (void)initGLResource
{
    ...
    NSString *modelVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMaterial/shaders/cube.vert"];
    NSString *modelFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMaterial/shaders/cube.frag"];
    _modelShader = new Shader(modelVertexPath.UTF8String, modelFragPath.UTF8String);
    
    NSString *lampVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMaterial/shaders/lamp.vert"];
    NSString *lampFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/lightWithMaterial/shaders/lamp.frag"];
...
- (void)render
{
    ...
    //material+light一共有10+12个参数，可以使用UISilder来调整
    
    //设置material.ambient
    glUniform3f(glGetUniformLocation(_modelShader->_programId, "material.ambient"), 1.0f, 0.5f, 0.31f);
    //设置material.diffuse
    glUniform3f(glGetUniformLocation(_modelShader->_programId, "material.diffuse"), 1.0f, 0.5f, 0.31f);
    //设置material.specular
    glUniform3f(glGetUniformLocation(_modelShader->_programId, "material.specular"), 0.5f, 0.5f, 0.5f);
    ...
    glUniform3f(glGetUniformLocation(_modelShader->_programId, "light.position"), lampPos[0], lampPos[1], lampPos[2]);
