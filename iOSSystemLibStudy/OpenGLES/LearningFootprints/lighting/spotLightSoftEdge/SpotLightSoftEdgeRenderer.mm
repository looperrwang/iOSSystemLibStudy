...
@interface SpotLightSoftEdgeRenderer ()
...
@implementation SpotLightSoftEdgeRenderer
...
- (void)initGLResource
{
    ...
    NSString *modelVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/spotLightSoftEdge/shaders/cube.vert"];
    NSString *modelFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/spotLightSoftEdge/shaders/cube.frag"];
    _modelShader = new Shader(modelVertexPath.UTF8String, modelFragPath.UTF8String);
    
    NSString *lampVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/spotLightSoftEdge/shaders/lamp.vert"];
    NSString *lampFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/lighting/spotLightSoftEdge/shaders/lamp.frag"];
...
- (void)render
{
    ...
    //设置light.outerCutoff
    glUniform1f(glGetUniformLocation(_modelShader->_programId, "light.cutoff"), cosf(17.5f * M_PI / 180.0f));
    //衰减
