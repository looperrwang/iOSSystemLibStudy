//
//  LightingInViewSpaceViewController.m
//  iOSSystemLibStudy
//
...
#import "LightingInViewSpaceViewController.h"
#import "LightingInViewSpaceRenderer.h"

@interface LightingInViewSpaceViewController ()

@property (nonatomic, strong) LightingInViewSpaceRenderer *renderer;

@end

@implementation LightingInViewSpaceViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.title = @"LightingInViewSpace";
...
{
    if (!_renderer) {
        _renderer = [[LightingInViewSpaceRenderer alloc] init];
    }
