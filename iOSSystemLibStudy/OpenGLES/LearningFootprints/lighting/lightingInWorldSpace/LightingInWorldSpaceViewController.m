//
//  LightingInWorldSpaceViewController.m
//  iOSSystemLibStudy
//
...
#import "LightingInWorldSpaceViewController.h"
#import "LightingInWorldSpaceRenderer.h"

@interface LightingInWorldSpaceViewController ()

@property (nonatomic, strong) LightingInWorldSpaceRenderer *renderer;

@end

@implementation LightingInWorldSpaceViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    self.title = @"LightingInWorldSpace";
...
{
    if (!_renderer) {
        _renderer = [[LightingInWorldSpaceRenderer alloc] init];
    }
