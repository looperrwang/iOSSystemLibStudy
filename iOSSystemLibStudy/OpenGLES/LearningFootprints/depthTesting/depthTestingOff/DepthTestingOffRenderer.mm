...
@interface DepthTestingOffRenderer ()
...
@implementation DepthTestingOffRenderer
...
- (void)initGLResource
{
    ...
    NSString *vertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/depthTesting/onOff/shaders/depthTest.vert"];
    NSString *fragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/depthTesting/onOff/shaders/depthTest.frag"];
