...
@interface BlendViewController () <UITableViewDataSource, UITableViewDelegate>
...
- (void)initCellData
{
    [self.data addObject:[[CellData alloc] initWithText:@"Transparent" vcName:@"TransparentViewController"]];
    [self.data addObject:[[CellData alloc] initWithText:@"Semitransparent" vcName:@"SemitransparentViewController"]];
}
...
{
    static NSString *reuseIdentifier = @"Blend";
