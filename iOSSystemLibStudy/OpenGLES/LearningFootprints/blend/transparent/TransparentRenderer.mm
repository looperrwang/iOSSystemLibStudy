...
@property (nonatomic, assign) std::vector<vec3> vegetation;
...
@implementation TransparentRenderer
...
- (void)initGLResource
{
    ...
    _vegetation.push_back(vec3(-1.5f, 0.0f, -0.48f));
    _vegetation.push_back(vec3(1.5f, 0.0f, 0.51f));
    _vegetation.push_back(vec3(0.0f, 0.0f, 0.7f));
    _vegetation.push_back(vec3(-0.3f, 0.0f, -2.3f));
    _vegetation.push_back(vec3(0.5f, 0.0f, -0.6f));
    ...
    NSString *transparentTexturePath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/resources/textures/grass.png"];
    ...
    NSString *cubeVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/blend/transparent/shaders/cube.vert"];
    NSString *cubeFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/blend/transparent/shaders/cube.frag"];
    _cubeShader = new Shader(cubeVertexPath.UTF8String, cubeFragPath.UTF8String);
    
    NSString *transparentVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/blend/transparent/shaders/transparent.vert"];
    NSString *transparentFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/blend/transparent/shaders/transparent.frag"];
...
- (void)render
{
    ...
    for (std::vector<vec3>::const_iterator it = _vegetation.begin(); it != _vegetation.end(); it++) {
        mtxLoadIdentity(model);
        const vec3 &v = *it;
        mtxTranslateMatrix(model, v.x, v.y, v.z);
