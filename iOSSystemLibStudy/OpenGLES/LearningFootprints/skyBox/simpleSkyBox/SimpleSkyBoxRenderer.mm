...
@interface SimpleSkyBoxRenderer ()
...
@implementation SimpleSkyBoxRenderer
...
- (void)initGLResource
{
    ...
    NSString *sceneVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/skyBox/simpleSkyBox/shaders/scene.vert"];
    NSString *sceneFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/skyBox/simpleSkyBox/shaders/scene.frag"];
    _sceneShader = new Shader(sceneVertexPath.UTF8String, sceneFragPath.UTF8String);
    
    NSString *skyBoxVertexPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/skyBox/simpleSkyBox/shaders/skybox.vert"];
    NSString *skyBoxFragPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"resource/OpenGLES/LearningFootprints/skyBox/simpleSkyBox/shaders/skybox.frag"];
...
- (void)render
{
    ...
    glDepthMask(GL_FALSE); //绘制skybox不写深度缓冲区
    ...
    GLfloat eyePos[3] = {r * sinf(viewRad), 0.0f, r * cosf(viewRad)};
    r += 0.01f;
    if (r > 10.0f) {
        r = 3.0f;
    }
