//
//  OfficialSamplesViewController.m
//  iOSSystemLibStudy
//
...
#import "OfficialSamplesViewController.h"
#import "CellData.h"

@interface OfficialSamplesViewController () <UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, strong) NSMutableArray<CellData *> *data;

@end

@implementation OfficialSamplesViewController
...
{
    static NSString *reuseIdentifier = @"OfficialSamples";
