...
- (void)initCellData
{
    ...
    [self.data addObject:[[CellData alloc] initWithText:@"DeferredLighting" vcName:@"DeferredLightingViewController"]];
    [self.data addObject:[[CellData alloc] initWithText:@"HelloCompute" vcName:@"HelloComputeViewController"]];
}
