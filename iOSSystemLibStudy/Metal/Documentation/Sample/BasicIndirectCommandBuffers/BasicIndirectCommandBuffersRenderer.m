...
#import "BasicIndirectCommandBuffersRenderer.h"
...
@implementation BasicIndirectCommandBuffersRenderer
{
...
- (nonnull instancetype)initWithMetalKitView:(nonnull MTKView *)mtkView
{
    ...
    if(self)
    {
        ...
        id <MTLFunction> vertexFunction = [defaultLibrary newFunctionWithName:@"BasicIndirectCommandBuffersVertexShader"];

        // Load the fragment function into the library
        id <MTLFunction> fragmentFunction = [defaultLibrary newFunctionWithName:@"BasicIndirectCommandBuffersFragmentShader"];
