...
#import "ArgumentBufferArraysWithHeapsShaderTypes.h"
...
@implementation ArgumentBufferArraysWithHeapsRenderer
{
...
- (nonnull instancetype)initWithMetalKitView:(nonnull MTKView *)mtkView
{
    ...
    if(self)
    {
        ...
        id <MTLFunction> vertexFunction = [defaultLibrary newFunctionWithName:@"ArgumentBufferArraysWithHeapsVertexShader"];

        // Load the fragment function from the library
        id <MTLFunction> fragmentFunction = [defaultLibrary newFunctionWithName:@"ArgumentBufferArraysWithHeapsFragmentShader"];
...
- (void) loadResources
{
    ...
    for(NSUInteger i = 0; i < AAPLNumBufferArguments; i++)
    {
        ...
        uint32_t elementCount = rand() % 384 + 128;
