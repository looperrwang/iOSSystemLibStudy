...
@implementation DeferredLightingRenderer
{
    ...
    NSArray<DeferredLightingMesh *> *_meshes;
    ...
    DeferredLightingBufferExamination *_bufferExamination;
#endif
}
...
#if SUPPORT_BUFFER_EXAMINATION_MODE
    _bufferExamination =  [[DeferredLightingBufferExamination alloc] initWithMTKView:_view
                                                                renderer:self];
#endif
...
- (void)loadAssets
{
    ...
    _meshes = [DeferredLightingMesh newMeshesFromURL:modelFileURL
...
/// Draw our DeferredLightingMesh objects with the given renderEncoder
- (void) drawMeshes:(nonnull id<MTLRenderCommandEncoder>)renderEncoder
{
    for (__unsafe_unretained DeferredLightingMesh *mesh in _meshes)
    {
