...
@implementation DeferredLightingViewController
{
    MTKView *_view;

    DeferredLightingRenderer_iOS *_renderer;
}
...
- (void)viewDidLoad
{
    ...
    _renderer = [[DeferredLightingRenderer_iOS alloc] initWithMetalKitView:_view];
