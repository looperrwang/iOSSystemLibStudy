...
// Generate a "random" UV from a incremental seed value
float2 randUv(float inSeed)
{
    return float2(fract(inSeed * .7234), fract(inSeed * .2352));
}
