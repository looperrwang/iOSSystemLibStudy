             ...
             library: (id <MTLLibrary>) library
{
    ...
    _particleMeshes =
    @[
        LoadParticleMesh (device, @"DynamicTerrainWithArgumentBuffersMeshes/Particles/Cloud.obj"),
        LoadParticleMesh (device, @"DynamicTerrainWithArgumentBuffersMeshes/Particles/Rock.obj")
    ];
